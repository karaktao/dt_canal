...
public class TransportDemand extends BaseEntity
{
    ...
    @Excel(name = "船舶可用时间段", width = 30, dateFormat = "yyyy-MM-dd")
    ...
    /** 出发时间起 */
    @JsonFormat(pattern = "yyyy-MM-dd")
    @Excel(name = "出发时间起", width = 30, dateFormat = "yyyy-MM-dd")
    private Date departureStart;

    /** 出发时间止 */
    @JsonFormat(pattern = "yyyy-MM-dd")
    @Excel(name = "出发时间止", width = 30, dateFormat = "yyyy-MM-dd")
    private Date departureEnd;

    /** 到达时间起 */
    @JsonFormat(pattern = "yyyy-MM-dd")
    @Excel(name = "到达时间起", width = 30, dateFormat = "yyyy-MM-dd")
    private Date arrivalStart;

    /** 到达时间止 */
    @JsonFormat(pattern = "yyyy-MM-dd")
    @Excel(name = "到达时间止", width = 30, dateFormat = "yyyy-MM-dd")
